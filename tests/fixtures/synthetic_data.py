...
COLLEGE_TEAMS = {
    'CMC-A': {
        ...
        'members': [
            {'name': 'James Taply', 'gender': 'M', 'lottery': True},
            {'name': 'Tom Oly', 'gender': 'M', 'lottery': False},
            {'name': 'John Pork', 'gender': 'M', 'lottery': True},
            {'name': 'Tommy White', 'gender': 'M', 'lottery': False},
            {'name': 'Kum Pon Nent', 'gender': 'F', 'lottery': True},
            {'name': 'Jackie Jackson', 'gender': 'F', 'lottery': True},
            {'name': 'Van Winkle', 'gender': 'F', 'lottery': False},
            {'name': 'Maxine Stonk', 'gender': 'F', 'lottery': False},
        ],
    },
    'CMC-B': {
        'school': 'Colorado Mormon College', 'abbrev': 'CMC',
        'members': [
            {'name': 'Seven Birds', 'gender': 'M', 'lottery': True},
            {'name': 'Benny Jeserit', 'gender': 'M', 'lottery': False},
            {'name': 'Blue Whale', 'gender': 'M', 'lottery': False},
            {'name': 'Luigi Mangione', 'gender': 'M', 'lottery': False},
            {'name': 'Rebecca Raytheon', 'gender': 'F', 'lottery': True},
            {'name': 'Helen Oftroy', 'gender': 'F', 'lottery': False},
            {'name': 'Becky Aquafina', 'gender': 'F', 'lottery': True},
            {'name': 'Carmen Sandiego', 'gender': 'F', 'lottery': False},
        ],
    },
    'CMC-C': {
        'school': 'Colorado Mormon College', 'abbrev': 'CMC',
        'members': [
            {'name': 'Zix Zeben', 'gender': 'M', 'lottery': False},
            {'name': 'Tommy Wheat', 'gender': 'M', 'lottery': False},
            {'name': 'Kyu Min', 'gender': 'M', 'lottery': False},
            {'name': 'Indiana Surprise', 'gender': 'M', 'lottery': True},
            {'name': 'Calamari Nodules', 'gender': 'F', 'lottery': False},
            {'name': 'Mandy Applebees', 'gender': 'F', 'lottery': False},
            {'name': 'Rose Mary', 'gender': 'F', 'lottery': True},
            {'name': 'Samantha Paprika', 'gender': 'F', 'lottery': False},
        ],
    },
    'CCU-A': {
        'school': 'Crease Christian University', 'abbrev': 'CCU',
        'members': [
            {'name': 'Joe Squamjo', 'gender': 'M', 'lottery': True},
            {'name': 'Squinge Timbler', 'gender': 'M', 'lottery': False},
            {'name': 'Bumbldy Pumpldy', 'gender': 'M', 'lottery': False},
            {'name': 'Alfred Pogo', 'gender': 'M', 'lottery': False},
            {'name': 'Jilliam Jwilliam', 'gender': 'F', 'lottery': True},
            {'name': 'Beverly Crease', 'gender': 'F', 'lottery': False},
            {'name': 'Jo March', 'gender': 'F', 'lottery': False},
            {'name': 'Polisa Wurst', 'gender': 'F', 'lottery': False},
        ],
    },
    'CCU-B': {
        'school': 'Crease Christian University', 'abbrev': 'CCU',
        'members': [
            {'name': 'Bill Bishoff', 'gender': 'M', 'lottery': False},
            {'name': 'Thomas Grungle', 'gender': 'M', 'lottery': False},
            {'name': 'Neyooxet Greymorning', 'gender': 'M', 'lottery': True},
            {'name': 'Dan Legacy', 'gender': 'M', 'lottery': False},
            {'name': 'Jethrow Pike', 'gender': 'M', 'lottery': False},
            {'name': 'Andrea Duracell', 'gender': 'F', 'lottery': False},
            {'name': 'Abigail Eucerin', 'gender': 'F', 'lottery': True},
        ],
    },
    'TCU-A': {
        'school': 'Texas Christian University', 'abbrev': 'TCU',
        'members': [
            {'name': 'Pilsner Reich', 'gender': 'M', 'lottery': False},
            {'name': 'Sprainard Castille', 'gender': 'M', 'lottery': False},
            {'name': 'Pocket', 'gender': 'M', 'lottery': False},
            {'name': 'Hidden Dragon', 'gender': 'M', 'lottery': True},
            {'name': 'Cronartium Ribicola', 'gender': 'F', 'lottery': True},
            {'name': 'Listeria Winner', 'gender': 'F', 'lottery': False},
            {'name': 'Green Grass', 'gender': 'F', 'lottery': False},
            {'name': 'Abigail Crease', 'gender': 'F', 'lottery': False},
        ],
    },
    'JT-A': {
        'school': 'Jesuit Tech', 'abbrev': 'JT',
        'members': [
            {'name': 'Autonomic Dysfunction', 'gender': 'M', 'lottery': True},
            {'name': 'Canya Stop', 'gender': 'M', 'lottery': False},
            {'name': 'Gimme Five', 'gender': 'F', 'lottery': True},
            {'name': 'Gronald Grop', 'gender': 'F', 'lottery': False},
            {'name': 'Ben Wise', 'gender': 'F', 'lottery': False},
        ],
    },
}

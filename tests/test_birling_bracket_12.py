...
class TestBracketGeneration12:
    ...
    def test_non_bye_matches_have_two_competitors(self):
        ...
        # 12 is even, so the compact shape pairs everyone: 6 matches, 0 byes.
        # The old value of 4 was left over from the padded 16-slot shape, where
        # 12 competitors produced 8 first-round matches of which 4 were byes.
        assert len(non_bye) == 6, "12 competitors → 6 actual first-round matches"

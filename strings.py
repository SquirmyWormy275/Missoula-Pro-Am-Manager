...
ENGLISH = {
    ...
    'FLASH': {
        ...
        'shadow_cutoff_required': 'Choose the exclusive UTC prediction cutoff date.',
        'shadow_field_prepared': 'Shadow field snapshot prepared. Review the preflight summary.',
        'shadow_prepare_first': 'Prepare a shadow field snapshot first.',
        'shadow_preflight_approved': 'Preflight approved for this exact field revision.',
        'shadow_receipt_recorded': 'Trusted STRATHMARK receipt recorded.',
        'shadow_sheet_reviewed': 'Every recommendation, including zero, was explicitly reviewed.',
        'shadow_sheet_issued': 'Entire shadow sheet issued and checksummed.',
        'shadow_reconcile_confirmation_required': 'Confirm the outcome reconciliation before recording it.',
        'shadow_outcomes_recorded': 'Recorded {outcome_count} outcome correction(s); {numeric_action_count} numeric settle/void action(s) queued.',
        'shadow_unknown_context_recorded': 'Explicit unknown context recorded without changing V2 numbers.',
        'shadow_context_recorded': 'Recorded {recorded_count} structured context observation(s).',
        'shadow_unknown_context_task': 'Unknown context capture task.',
        'shadow_unknown_action': 'Unknown shadow workflow action.',
        'shadow_authority_locked': '{event_name} authority cannot be changed after its shadow run reached {lifecycle}.',
    },
    'UI': {
        'language': 'Language',
        'dashboard': 'Dashboard',
